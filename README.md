...
WordPress theme + site code for **Calmara** brand, market **GR**.

- **Subdomain:** `gr_calmara.noriks.com` → `18.197.40.171` (brand-machine)
- **Theme:** `calmara/` (forked from Noriks WP theme, Storefront-based)
- **Source:** copied from `wp-noriks-gr{-pravi?}` on 2026-06-09
